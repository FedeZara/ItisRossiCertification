                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-12 col-md-3 text-right">
                        <div class="btn-group">
                          ...
                          data-popout="true" data-course-id ='. $course_id .'
                          data-title="Vuoi davvero cancellare il corso?" data-content="Tutte le iscrizioni al corso verranno perse..." id="btnRemove"><span class="glyphicon glyphicon-remove"></span></button>
                        </div>
                      </div>
                    </div>
                  </div>
